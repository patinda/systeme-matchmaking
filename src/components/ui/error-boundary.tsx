...
export class ErrorBoundary extends Component<Props, State> {
  ...
  private generateErrorReport(): string {
    ...
    return `=== RAPPORT D'ERREUR MATCHMAKING ===
Timestamp: ${timestamp}
...
function ErrorFallback({ 
  ...
  const isAdmin = true; // Toujours afficher les détails techniques
        ...
        {(!userLoaded || !isAdmin) && (
          <Card>
            ...
            <CardContent>
              ...
              <Button 
                onClick={() => {
                  const mailtoLink = `mailto:support@matchmaking.com?subject=Problème technique - ${window.location.href}&body=Bonjour,%0D%0A%0D%0AJ'ai rencontré une erreur sur la page: ${window.location.href}%0D%0A%0D%0APouvez-vous m'aider ?%0D%0A%0D%0AMerci.`;
